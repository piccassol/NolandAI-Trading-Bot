...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#1A1D26] text-gray-100">
      {/* Header */}
      <header className="border-b border-gray-800 bg-[#1A1D26] p-2">
        <div className="flex items-center justify-between px-4">
          <div className="flex items-center space-x-8">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_8397-3NSpHrNawOMDu5B3E6hWs3g4N7Lwd9.jpeg"
              alt="3Commas"
              className="h-8"
            />
            <div className="flex space-x-6">
              <div className="text-sm">
                <div className="flex items-center space-x-2">
                  <span>BTC/USD</span>
                  <span className="text-red-500">$57,557.47</span>
                </div>
                <div className="text-red-500">-2.85%</div>
              </div>
              <div className="text-sm">
                <div className="flex items-center space-x-2">
                  <span>ETH/USD</span>
